...
(defun execute-chrome (url)
  (interactive)
  (call-process-shell-command (concat "cmd.exe /k \"c:\\Users\\jaejinpark\\chrome.bat "  url "\"") nil 0))
...
#+begin_src elisp
(execute-chrome "https://google.com")
#+end_src
...
(after! org
  ...
  ;;구글 달력과 연동한다.
  (run-with-timer 0 200 'org-gcal-sync)
  ;;저장된 파일 리스트를 불러온다.
...
;;   '("elisp" "go" "python" "ipython" "bash" "sh" "js" "typescript"))
